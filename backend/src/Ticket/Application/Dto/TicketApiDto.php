...
/**
 * DTO для парсинга ответа от Freshdesk API при получении данных задачи.
 *
 ...
 */
final readonly class TicketApiDto
{
    /**
     * @param int $id ID задачи в Freshdesk системе
     ...
     * @param string|null $dueBy Срок решения задачи (в формате ISO 8601)
     * @param string|null $frDueBy Первый ответ по SLA (в формате ISO 8601)
     ...
     * @param string $createdAt Создание задачи в Freshdesk (в формате ISO 8601)
     * @param string $updatedAt Последнее обновление в Freshdesk (в формате ISO 8601)
     */
     ...
     *
     * @param array<string, mixed> $data Массив данных из Freshdesk API
     */
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            descriptionText: $data['description_text'] ?? null,
            type: $data['type'] ?? null,
            ...
            ccEmails: $data['cc_emails'] ?? null,
            toEmails: $data['to_emails'] ?? null,
            fwdEmails: $data['fwd_emails'] ?? null,
            replyCcEmails: $data['reply_cc_emails'] ?? null,
            emailConfigId: $data['email_config_id'] ?? null,
            ...
            frDueBy: $data['fr_due_by'] ?? null,
            isOverdue: (bool) ($data['is_overdue'] ?? false),
            frEscalated: isset($data['fr_escalated']) ? (bool) $data['fr_escalated'] : null,
            slaPolicyId: $data['sla_policy_id'] ?? null,
